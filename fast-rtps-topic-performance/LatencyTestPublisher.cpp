...
std::vector<uint32_t> data_size_pub (dataspub, dataspub + 1 );
#else
...
//zhouyoujun:
#ifdef NO_CONTINUOUS_MODE
bool LatencyTestPublisher::init(int n_sub, int n_sam, bool reliable, uint32_t pid, bool hostname, bool export_csv, uint32_t msg_len)
#else
